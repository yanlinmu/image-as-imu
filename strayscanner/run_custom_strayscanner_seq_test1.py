...
def main(cfg: DictConfig):
    ...
    if cfg.viz_metrics:
        ...
        viz_time_series(pred_rot_vels, imu_gyro_N3, frame_ts, imu_ts,
                     rot_or_trans="rot", title=rot_title, save_path="/home/myl/strayscanner_data/precomputed_vels_iaai_test1/plots/rot_vels.png")
        viz_time_series(pred_trans_vels, arkit_tvel_N3, frame_ts, arkit_ts,
                     rot_or_trans="trans", title=trans_title, save_path="/home/myl/strayscanner_data/precomputed_vels_iaai_test1/plots/trans_vels.png")
