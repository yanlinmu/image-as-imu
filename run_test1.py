...
opencv2gyro_tf = torch.tensor([[ 0, -1,  0],
                               ...
                               [ 0,  0, -1]]).float()
# gyro坐标系角速度
omega_gyro = torch.tensor([[0.098444894,-0.08518917,0.14840649]], dtype=torch.float32)
# omega_gyro = torch.tensor([[0, 0, 0]], dtype=torch.float32)
# # 转换到相机坐标系
# omega_cam = omega_gyro @ opencv2gyro_tf.T

demo_img = Image.open("/home/myl/synthetic_data/train/blurred/00777c41d4_46.png")
data = {"image": demo_img, "fx": 251.36300659179688, "fy": 251.7480010986328, "imu_gyro": omega_gyro} # fx, fy相机内参中的焦距
# 单张图片推理计时
